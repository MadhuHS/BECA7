...
class Account//Bank Account
{
	...
	public void setBal(double bal)//intialize
	{
		...
		{
			IllegalArgumentException ie = new IllegalArgumentException("TRANSACTION FAILED due to INVALID AMT");
		    throw ie;
		    
	//throw	new IllegalArgumentException("TRANSACTION FAILED due to INVALID AMT");      
		}
	}
